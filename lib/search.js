...
server.get('/results/:requestId/', function(req, res, next) {   // Django ResultsView
...
server.post('/search', function (req, res, next) {              // Django SearchView
